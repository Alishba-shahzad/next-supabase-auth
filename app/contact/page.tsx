...
const Contact: React.FC = () => {
  ...
  return (
    <div className="flex-1 flex flex-col p-2 gap-4 relative">
      ...
      <div className="flex">
        <Link href="/" className="py-2 px-4 rounded-md text-white bg-customFormBg flex items-center group text-sm">
      ...
      <div className="py-23">
        <div className="mx-auto max-w-5xl px-2 sm:px-4 lg:px-6">
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-24">
            <div className="flex items-center lg:mb-0 mb-10">
              <div>
                <h4 className="text-pink-600 text-4xl font-bold mb-4 lg:text-left text-center">Contact Us</h4>
                <h2 className="text-gray-900 text-base font-semibold mb-9 lg:text-left text-center">
                  Reach Out To Us, <br /> <b>Fill out the form below to contact.</b>
                </h2>
                <form onSubmit={handleSubmit}>
                  <input
                    ...
                    className="w-full h-14 shadow-sm text-gray-600 text-lg rounded-full border border-gray-200 focus:outline-none py-2 px-4 mb-2"
                    placeholder="Name"
                    required
                  />
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full h-48 shadow-sm resize-none text-gray-600 text-lg rounded-2xl border border-gray-200 focus:outline-none px-4 py-2 mb-2"
                    placeholder="Message"
                  ></textarea>
                  {errors.message && <p className="text-red-500 text-sm">{errors.message}</p>}

                  <button type="submit"
                    className="w-full h-12 text-center text-white text-base font-semibold rounded-full bg-customFormBg shadow transition-all duration-700 hover:bg-pink-800">
                    Submit
                  </button>
                </form>
              </div>
            </div>
            <div className="lg:max-w-xl w-full h-[600px] flex items-center justify-center  bg-cover bg-no-repeat bg-customFormBg">
          <div className="">
              <div className="lg:w-96 w-auto h-auto bg-white shadow-xl lg:p-6 p-4">
                  ...
                  </svg> */} <h2 className='text-base font-medium leading-6 text-center font-semibold mb-4 no-underline hover:underline mx-auto'>Contact</h2>
                  <a href="javascript:;" className="flex items-center mb-6">
                      ...
                      <h5 className="text-black text-base font-normal leading-6 ml-5">470-123-678</h5>
                  </a>
                  <a href="javascript:;" className="flex items-center mb-6">
                      <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <h5 className="text-black text-base font-normal leading-6 ml-5">abc1234@gmail.com</h5>
                  </a>
                  <a href="javascript:;" className="flex items-center mb-6">
                      <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <h5 className="text-black text-base font-normal leading-6 ml-5">789 US, Defense, l-543</h5>
                  </a>
                  <div className="flex items-center justify-center border-t border-red-100 pt-6">
